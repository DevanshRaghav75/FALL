...
print(Fore.GREEN + Style.BRIGHT + ''' 
              ...
              ╚═╝     ╚═╝  ╚═╝╚══════╝╚══════╝
''')
print(Fore.WHITE + Style.BRIGHT + '       :.:.:Coded with' + Fore.RED + " <3 " + Fore.WHITE + 'by: @Hs Devansh Raghav:.:.:' + Style.RESET_ALL)
print('')
...
while True:
    try:
        ...
        if handler == '1':
            ...
            print('')
            print(Fore.RED + "[-_-] " + Style.RESET_ALL + "Unknown option: " + handler)
            print('')

    except (KeyboardInterrupt):

        print("")
        print(Fore.RED + "[ERROR] " + Style.RESET_ALL + "Unexpected error occurred !")
        sys.exit()
